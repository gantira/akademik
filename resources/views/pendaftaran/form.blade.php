	<div class="field">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('nama_lengkap') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('nama_panggilan') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('tempat_lahir') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('agama') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="two wide field {{ $errors->first('anak_ke') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="thirteen wide field">
				<div class="three wide field {{ $errors->first('kandung') ? 'error' : '' }}">
		    	...
		    	<div class="three wide field {{ $errors->first('tiri') ? 'error' : '' }}">
		    	...
		    	<div class="three wide field {{ $errors->first('angkat') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('anak_dalam_keluarga') ? 'error' : '' }}">
		    	{{ Form::select('anak_dalam_keluarga', ['Yatim'=>'Yatim', 'Piatu'=>'Piatu', 'Yatim Piatu'=>'Yatim Piatu', 'Lainnya'=>'Lainnya'], null, ['placeholder'=>'', 'class'=>'ui dropdown']) }}
		    </div>
	  </div>
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('bahasa') ? 'error' : '' }}">
...
<br>
	  <div class="field">
		...
		<div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('alamat') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('kelurahan') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('kecamatan') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('kota') ? 'error' : '' }}">
		...
		<div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('kode_pos') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('telepon') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('tinggal') ? 'error' : '' }}">
	    	{{ Form::select('tinggal', ['Dengan Orang Tua'=>'Dengan Orang Tua', 'Menumpang'=>'Menumpang', 'Asrama'=>'Asrama', 'Ngontrak'=>'Ngontrak', 'Lainnya'=>'Lainnya'], null, ['placeholder'=>'', 'class'=>'ui dropdown']) }}
	    </div>
	  </div>
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('transportasi') ? 'error' : '' }}">
	    	{{ Form::select('transportasi', ['Jalan Kaki'=>'Jalan Kaki', 'Angkutan Umum'=>'Angkutan Umum', 'Motor Pribadi'=>'Motor Pribadi', 'Mobil Pribadi'=>'Mobil Pribadi', 'Lainnya'=>'Lainnya'], null, ['placeholder'=>'', 'class'=>'ui dropdown']) }}
	    </div>
	  </div>
	  ...
	  <div class="inline fields">
			...
			<div class="six wide field {{ $errors->first('jarak_sekolah') ? 'error' : '' }}">
	    	{{ Form::select('jarak_sekolah', ['1 Km'=>'1 Km', '1 - 3 Km'=>'1 - 3 Km', '5 - 10 Km'=>'5 - 10 Km', '> 10 Km'=>'> 10 Km'], null, ['placeholder'=>'', 'class'=>'ui dropdown']) }}
	    </div>
	  </div>
<br>
	  <div class="field">
		...
		<div class="inline fields">
			...
			<div class="thirteen wide field">
				<div class="three wide field {{ $errors->first('kg') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="thirteen wide field">
				<div class="three wide field {{ $errors->first('cm') ? 'error' : '' }}">
	  ...
	  <div class="inline fields">
			...
			<div class="thirteen wide field {{ $errors->first('penyakit_berat') ? 'error' : '' }}">
	    ...
	    <div class="sixteen wide field">
		    ...
		    <ul>
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	...
					    	<div class="six wide field {{ $errors->first('sd_nama') ? 'error' : '' }}">
				    ...
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	...
					    	<div class="six wide field {{ $errors->first('sd_no_ijazah') ? 'error' : '' }}">
					    		{{ Form::text('sd_no_ijazah', null, ['placeholder'=>'']) }}
					    	</div>
					    	<label class="field">Tahun</label>
					    	<div class="two wide field {{ $errors->first('sd_no_ijazah_tahun') ? 'error' : '' }}">
				    ...
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	...
					    	<div class="two wide field {{ $errors->first('sd_lama_belajar') ? 'error' : '' }}">
		    ...
		    <ul>
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	<label class="two wide field">Nama Sekolah</label>
					    	<div class="six wide field {{ $errors->first('smp_nama') ? 'error' : '' }}">
				    ...
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	<label class="two wide field">No. Seri Ijazah</label>
					    	<div class="six wide field {{ $errors->first('smp_no_ijazah') ? 'error' : '' }}">
					    		{{ Form::text('smp_no_ijazah', null, ['placeholder'=>'']) }}
					    	</div>
					    	<label class="field">Tahun</label>
					    	<div class="two wide field {{ $errors->first('smp_no_ijazah_tahun') ? 'error' : '' }}">
				    ...
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	...
					    	<div class="six wide field {{ $errors->first('no_skhun') ? 'error' : '' }}">
					    		{{ Form::text('no_skhun', null, ['placeholder'=>'']) }}
					    	</div>
					    	<label class="field">Tahun</label>
					    	<div class="two wide field {{ $errors->first('no_skhun_tahun') ? 'error' : '' }}">
				    ...
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	<label class="two wide field">Lama Belajar</label>
					    	<div class="two wide field {{ $errors->first('lama_belajar') ? 'error' : '' }}">
		    ...
		    <ul>
				    <div class="inline fields">
				    	<div class="sixteen wide field">
					    	<label class="two wide field">Nama Sekolah</label>
					    	<div class="six wide field {{ $errors->first('nama_sekolah_pindahan') ? 'error' : '' }}">
...
<br>
		    <div class="field">
				...
				<div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('nama_ayah') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('tempat_lahir_ayah') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			  ...
			  <div class="inline fields">
			   ...
			   <div class="inline fields">
			    	...
			    	<div class="four wide field {{ $errors->first('penghasilan_ayah') ? 'error' : '' }}">
			    		{{ Form::select('penghasilan_ayah', 
			    		['<= Rp. 500.000'=>'<= Rp. 500.000', 
			    		 '500.000 - 1.000.000'=>'500.000 - 1.000.000', 
			    		 '1.000.000 - 3.000.000'=>'1.000.000 - 3.000.000', 
			    		 '> 3.000.000'=>'> 3.000.000'], null,['placeholder'=>'', 'class'=>'ui dropdown']) }}
			    	</div>
		    </div>

		    <div class="inline fields">
			    	<label class="three wide field">No. Telepon/ HP</label>
			    	<div class="six wide field {{ $errors->first('telepon_ayah') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('alamat_ayah') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('nama_ibu') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	<label class="three wide field">Tempat Lahir</label>
			    	<div class="six wide field {{ $errors->first('tempat_lahir_ibu') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			  ...
			  <div class="inline fields">
			   ...
			   <div class="inline fields">
			    	<label class="three wide field">Penghasilan</label>
			    	<div class="four wide field {{ $errors->first('penghasilan_ibu') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	<label class="three wide field">No. Telepon/ HP</label>
			    	<div class="six wide field {{ $errors->first('telepon_ibu') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	<label class="three wide field">Alamat</label>
			    	<div class="six wide field {{ $errors->first('alamat_ibu') ? 'error' : '' }}">
...
<br>
		    <div class="field">
				...
				<div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('hobby') ? 'error' : '' }}">
		    ...
		    <div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('cita_cita') ? 'error' : '' }}">
		    ...
		    <div class="field">
				...
				<div class="inline fields">
			    	...
			    	<div class="six wide field {{ $errors->first('file_ijazah') ? 'error' : '' }}">
			    		{{ Form::file('file_ijazah', null) }}
				    	@if (!empty($pendaftaran->file_ijazah))
				    	<br>
				    		<img src="{{ asset($pendaftaran->file_ijazah) }}" class="ui tiny image">
				    	@endif
			    	</div>
		    </div>
		    ...
		    <div class="inline fields">
			    	...
			    	<div class="four wide field {{ $errors->first('nilai_ijazah') ? 'error' : '' }}">
